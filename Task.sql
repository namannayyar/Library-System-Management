...
be updated to 'no'. If the book is not available (status = 'no'), the procedure 
...
CREATE OR REPLACE PROCEDURE issued_book(p_issued_id varchar(10), p_issued_member_id varchar(10), 
...
--all the code
	...
	ELSE
		RAISE NOTICE 'Sorry to inform you the book you have requested is unavailable
		book_isbn: %', p_issued_book_isbn;
